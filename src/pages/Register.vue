<template>
  <div class="flex justify-center items-center min-h-screen container">
    <form class="flex flex-col bg-gray-900 p-5 rounded-xl w-96" @submit.prevent="submit">
      ...
      <p @click="$router.push('/login')" class="text-right cursor-pointer mt-2 underline underline-offset-8 hover:underline-offset-4 duration-300 hover:text-blue-400 ease-out">I have an account</p>
    </form>
  </div>
</template>
<script>
